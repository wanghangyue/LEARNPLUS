...
function errorselect(){
 ajax1.query('GET','checkerrorresponse.php?class='+$$('fenleiselect').value+'&level='+$$('levelselect').value+'&type='+$$('typeselect').value,update1);
}   
</script>
...
<div style="text-align:center;margin-top:85px;color:#000">
 <span style = "padding-left:20px;padding-right:20px;padding-top:10px;padding-bottom:10px; background-color:#E6E6FA;font-size:18px;font-weight:500">查看错题共获得<span style = "color:#ff0000"><?php include 'checkerrorquery.php';echo $count03;?></span>条结果，最多显示<span style = "color:#ff0000">100</span>条，您可以在左边选择反馈分类</span>
 </div>
  ...
  <div style="margin-top:5px;margin-left:115px;margin-right:115px;padding:5px 5px 10px 0px">
   <div style="width:300px;float:left;padding:5px 5px 5px 5px;text-align:center">
       <div style = "margin-top:10px;line-height:50px;height:50px;width:280px;background-color:#7700ff;color:#fff;font-size:20px;letter-spacing:2px;text-align:center;font-weight:bold;font-family:宋体">选择错题类型</div>
...
?> </div>
	  ...
	  <label for="refreshjs"><div onclick = "errorselect()" style = "cursor:pointer;margin-top:10px;line-height:50px;height:50px;width:280px;background-color:#7700ff;color:#fff;font-size:20px;letter-spacing:2px;text-align:left;font-weight:bold;font-family:宋体;padding-left:10px;text-align:center">点击获取错题结果</div></label>
   </div>
  ...
  foreach ($rows3 as $value){
	 ...
	 ?>    
       <a href="checkerrorshow.php?id=<?php echo $id; ?>">
