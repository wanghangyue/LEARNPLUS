...
function todaycan(){
 ajax1.query('GET','todaycanresponse.php',update1);
}   
</script>
<script language="javascript" type="text/javascript">
...
function todaycannot(){
 ajax2.query('GET','todaycannotresponse.php',update0);
}   
</script>
<script language="javascript" type="text/javascript">
...
function todayachieve(){
 ajax3.query('GET','todayachieveresponse.php',update3);
}   
</script>
<script language="javascript" type="text/javascript">
...
function todayerror(){
 ajax4.query('GET','todayerrorresponse.php',update4);
}   
</script>
<script language="javascript" type="text/javascript">
...
function todaykey(){
 ajax5.query('GET','todaykeyresponse.php',update5);
}   
</script>
...
<div style="text-align:center;margin-top:85px;color:#000">
 <span style = "padding-left:20px;padding-right:20px;padding-top:10px;padding-bottom:10px; background-color: #E6E6FA ;font-size:18px;font-weight:500">今日回顾共获得<span style = "color:#ff0000"> <?php include 'todayreviewquery.php';echo $count03;?></span>条结果，最多显示<span style = "color:#ff0000">100</span>条，请从左边选择分类查看</span>
 </div>
  ...
  <div style="margin-top:5px;margin-left:115px;margin-right:115px;padding:5px 5px 10px 0px">
   <div style="width:300px;float:left;padding:5px 5px 5px 5px;text-align:center">
       <label for="refreshjs"><div onclick = "todaycan()" style = "cursor:pointer;margin-top:10px;line-height:50px;height:50px;width:280px;<?php echo"background-color:#7700FF;"?>color:#fff;font-size:20px;letter-spacing:2px;text-align:center;font-weight:bold;font-family:宋体">今日会做</div></label>
       <label for="refreshjs"><div onclick = "todaycannot()" style = "cursor:pointer;margin-top:10px;line-height:50px;height:50px;width:280px;background-color:#7700FF;color:#fff;font-size:20px;letter-spacing:2px;text-align:center;font-weight:bold;font-family:宋体">今日不会做</div></label>
       <label for="refreshjs"><div onclick = "todayachieve()" style = "cursor:pointer;margin-top:10px;line-height:50px;height:50px;width:280px;background-color:#7700FF;color:#fff;font-size:20px;letter-spacing:2px;text-align:center;font-weight:bold;font-family:宋体">今日完成</div></label>
       <label for="refreshjs"><div onclick = "todaykey()" style = "cursor:pointer;margin-top:10px;line-height:50px;height:50px;width:280px;background-color:#7700FF;color:#fff;font-size:20px;letter-spacing:2px;text-align:center;font-weight:bold;font-family:宋体">今日重点</div></label>
       <label for="refreshjs"><div onclick = "todayerror()" style = "cursor:pointer;margin-top:10px;line-height:50px;height:50px;width:280px;background-color:#7700FF;color:#fff;font-size:20px;letter-spacing:2px;text-align:center;font-weight:bold;font-family:宋体">今日错题</div></label>
   </div>
   <div style="width:690px;float:right;padding:5px 5px 5px 5px;margin-bottom:50px">
       <?php  
  include 'todayreviewquery.php';
  foreach ($rows3 as $value){
	 ...
	 ?>    
       <a href="todayreviewshow.php?id=<?php echo $id; ?>">
